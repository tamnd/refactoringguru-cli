...
Most of these come down to network reality or how refactoringguru serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

refactoringguru rate-limits like any public site. refactoringguru already paces
...
Where a surface is gated, refactoringguru reads a cookie or token you supply
...
`refactoringguru`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what refactoringguru actually did
